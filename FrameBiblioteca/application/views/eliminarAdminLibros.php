...
<table class="table">
  ...
  <?php foreach($libros as $libro) { ?>
    <tr>
	  ...
	  <td><input type="submit" name="idbook" value="Eliminar Libro" onclick="enviar(<?php echo $libro->id_libro ?>)" class="btn btn-danger" id="idbook"></td>
...
{ 
    ...
    form.method = 'post';
    form.action = "<?= base_url() ?>Admin/deleteLibro";
