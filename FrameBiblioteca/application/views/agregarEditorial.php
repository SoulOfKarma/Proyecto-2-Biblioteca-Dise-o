...
<div class="col-md-8">
<form action="<?= base_url() ?>Admin/insertEditorial" method="post"><br>
        <label for="nomaut">Nombre Autor: </label>
         <input type="text" id="nomeditorial" name="nomeditorial" class="form-control" required="required"><br><br>
         <input type="submit" value="Insertar Editorial" class="btn btn-success" id="ir">
         </form>
</div>
<div class="col-md-2">
</div>
