...
<div class="col-md-8">
<form action="<?= base_url() ?>Admin/insertLibro" method="post"><br>
        <label for="nomlib">Nombre Libro: </label>
         <input type="text" id="nomlib" name="nomlib" class="form-control" required="required"><br><br>
		 <label for="nomlib">Codigo ISBN Libro: </label>
         <input type="text" id="codisbn" name="codisbn" class="form-control" required="required"><br><br>
...
<br>
         <input type="submit" value="Insertar Libro" class="btn btn-success" id="ir">
         </form>
</div>
</div>
<div class="col-md-2">
