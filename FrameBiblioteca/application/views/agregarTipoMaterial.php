...
<div class="col-md-8">
<form action="<?= base_url() ?>Admin/insertTipoMaterial" method="post"><br>
        <label for="nomaut">Nombre Material: </label>
         <input type="text" placeholder="Ej. Revistas" id="nomtipomaterial" name="nomtipomaterial" class="form-control" required="required"><br><br>
         <input type="submit" value="Insertar Tipo Material" class="btn btn-success" id="ir">
         </form>
</div>
<div class="col-md-2">
</div>
