...
<div class="col-md-8">
<form action="<?= base_url() ?>Admin/insertAutor" method="post"><br>
        <label for="nomaut">Nombre Autor: </label>
         <input type="text" id="nomautor" name="nomautor" class="form-control" required="required"><br><br>
         <input type="submit" value="Insertar Autor" class="btn btn-success" id="ir">
         </form>
</div>
<div class="col-md-2">
</div>
