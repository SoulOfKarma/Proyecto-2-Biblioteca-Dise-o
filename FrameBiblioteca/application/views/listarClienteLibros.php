...
<div class="row">
<div class="col-md-2">
<form action="<?= base_url() ?>Cliente/filtrarPorBusquedaAlum" method="post">
...
{ 
    ...
    form.method = 'post';
    form.action = "<?= base_url() ?>Cliente/filtrarPorBusquedaAutor";
...
{ 
    ...
    document.body.appendChild(form);
    form.method = 'post';
    form.action = "<?= base_url() ?>Cliente/filtrarPorBusquedaMaterial";
...
{ 
    ...
    document.body.appendChild(form);
    form.method = 'post';
    form.action = "<?= base_url() ?>Cliente/filtrarPorBusquedaEditorial";
